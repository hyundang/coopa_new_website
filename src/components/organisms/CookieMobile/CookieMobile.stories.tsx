...
import CookieMobile, { CookieMobileProps } from ".";

export default {
  title: "components/organisms/CookieMobile",
  component: CookieMobile,
} as Meta;

const Template: Story<CookieMobileProps> = (args) => {
...
export const cookieMobile = Template.bind({});

export const sharedCookieMobile = Template.bind({});
sharedCookieMobile.args = {
  isShared: true,
};
...
const cookies = [
  ...
  {
    content: "이번 플리는 오래전부터 좋아했던 아티스트",
    directoryInfo: {
      emoji: null,
      id: 1367,
      name: "playlist🎧",
